...
<body>
  ...
  <div class="navbar">
        ...
        <a href="studenthome.jsp?id=<%=student.getName()%>">Student</a>
		...
		<table align="center" style="font-size: 25px;margin-top: 30px" border="2" cellpadding="13">
			...
			<tbody>
				...
				<tr>
					...
					<td style="text-align: center;" ><a href="feedbackFormsub.jsp?sub=<%=e.getSub_name()%>">Click For Feedback</a></td>
				...
				<tr>
					...
					<td><a style="color:red" href="studenthome.jsp?id=<%=student.getName() %>" >DashBoard</a> </td>
